...
const distributeCandies = (candyType) => {
  ...
  const allowedAmount = candyType.length / 2

  return Math.min(uniqueCandyTypes.size, allowedAmount)
}
...
/* 
Pseudocode:
- Capture the unique types of candy
- Capture the allowed amount of candy that can be eaten
- Return the smaller number between the unique candy types and the allowed amount
of candy that can be eaten
*/